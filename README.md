...
با `-Watch` ترمینال باز می‌ماند تا تغییرات سورس فرانت‌اند وارد کانتینر شوند. برای اجرای سرویس‌ها در پس‌زمینه بدون همگام‌سازی سورس فرانت‌اند:
...
اگر بدون `-Watch` اجرا کنید، تغییرات جدید سورس فرانت‌اند خودکار وارد کانتینر نمی‌شوند؛ برای دریافت آن‌ها watch را فعال کنید یا ایمیج را بازسازی کنید. برای اعمال تغییر کد taskهای Celery، workerها را restart کنید:
