      ...
      {error ? (
        ...
        <div className="flex h-full w-full">
          ...
          {!isSidebarCollapsed && (
            <div
              className={cn(
                "vertical-scrollbar absolute end-0 z-13 scrollbar-sm flex h-full w-[24rem] flex-shrink-0 flex-col gap-3.5 overflow-y-auto border-s border-subtle bg-surface-1 px-6 shadow-raised-200 duration-300"
              )}
            >
