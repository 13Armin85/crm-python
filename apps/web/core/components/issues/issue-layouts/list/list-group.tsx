...
export const ListGroup = observer(function ListGroup(props: Props) {
  ...
  const loadMore = isPaginating ? (
    ...
    <div
      className={
        "relative flex h-11 cursor-pointer items-center gap-3 border border-transparent border-t-subtle-1 bg-surface-1 p-3 ps-8 text-13 font-medium text-accent-primary hover:text-accent-secondary hover:underline"
      }
  ...
  return validateEmptyIssueGroups(groupIssueCount) ? (
    ...
    >
      <Row
        className={cn("w-full flex-shrink-0 border-b border-subtle bg-layer-1 py-1 pe-3 hover:bg-layer-1-hover", {
