    ...
    <>
      {!issue ? (
        ...
        <div className="flex h-full w-full overflow-hidden">
          ...
          <div
            className="fixed end-0 z-[5] h-full w-full min-w-[300px] border-s border-subtle bg-surface-1 sm:w-1/2 md:relative md:w-1/4 lg:min-w-80 xl:min-w-96"
            style={issueDetailSidebarCollapsed ? { insetInlineEnd: `-${window?.innerWidth || 0}px` } : {}}
          >
            <IssueDetailsSidebar
              workspaceSlug={workspaceSlug}
              projectId={projectId}
