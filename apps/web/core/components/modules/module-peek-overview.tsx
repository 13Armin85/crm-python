  ...
  return (
    <>
      {peekModule && (
        <div
          ref={ref}
          className="absolute end-0 z-[9] flex h-full w-full max-w-[24rem] flex-shrink-0 flex-col gap-3.5 overflow-y-auto border-s border-subtle bg-surface-1 px-6 duration-300 md:relative"
          style={{
            boxShadow:
