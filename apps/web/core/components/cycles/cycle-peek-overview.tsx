  ...
  return (
    <>
      {peekCycle && projectId && (
        <div
          ref={ref}
          className="fixed end-0 z-[9] flex h-full w-full max-w-[21.5rem] flex-shrink-0 flex-col gap-3.5 overflow-y-auto border-s border-subtle bg-surface-1 px-4 duration-300 md:relative"
          style={{
            boxShadow:
