      ...
      <Accordion.Root className="w-96">
        <Accordion.Item value="item-1">
          <Accordion.Trigger asChild>
            <button className="bg-blue-500 hover:bg-blue-600 w-full rounded-md px-4 py-2 text-start text-on-color">
        ...
        <Accordion.Item value="item-2">
          <Accordion.Trigger asChild>
            <button className="bg-green-500 hover:bg-green-600 w-full rounded-md px-4 py-2 text-start text-on-color">
